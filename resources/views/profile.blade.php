...
<head>
        ...
        <!-- APP CSS & APP SCSS -->
        <link rel="preload" as="style" href="build/assets/app-e29e56ca.css" /><link rel="stylesheet" href="build/assets/app-e29e56ca.css" />      
    ...
    <body class="app sidebar-mini">
									...
									<div class="d-flex align-items-center">
										...
										<div class="header-element country-dropdown dropdown-center">
											...
											<a href="javascript:void(0);" class="header-link dropdown-toggle"
												...
												<img src="build/assets/images/flags-img/us_flag.jpg"
											...
											<div class="main-header-dropdown dropdown-menu dropdown-menu-end"
												...
												<ul class="mb-0">
													<li class="dropdown-item mb-1">
														<div class="d-flex align-items-center">
															<div class="pe-2">
																<img src="build/assets/images/flags-img/india_flag.jpg"
													...
													<li class="dropdown-item mb-1">
														<div class="d-flex align-items-center">
															<div class="pe-2">
																<img src="build/assets/images/flags-img/malaysia.jpg"
																	class="rounded-circle country-img" alt="img">
															</div>
															<div class="flex-grow-1">
													...
													<li class="dropdown-item mb-1">
														<div class="d-flex align-items-center">
															<div class="pe-2">
																<img src="build/assets/images/flags-img/italy_flag.jpg"
																	class="rounded-circle country-img" alt="img">
															</div>
															<div class="flex-grow-1">
													...
													<li class="dropdown-item mb-1">
														<div class="d-flex align-items-center">
															<div class="pe-2">
																<img src="build/assets/images/flags-img/argentina.jpg"
																	class="rounded-circle country-img" alt="img">
															</div>
															<div class="flex-grow-1">
													...
													<li class="dropdown-item mb-1">
														<div class="d-flex align-items-center">
															<div class="pe-2">
																<img src="build/assets/images/flags-img/turkey.jpg"
																	class="rounded-circle country-img" alt="img">
															</div>
															<div class="flex-grow-1">
												...
												<ul class="mb-0 overflow-auto" id="header-cart-items-scroll">
													<li class="dropdown-item">
														<div class="d-flex align-items-start cart-dropdown-item">
															<img src="build/assets/images/products/8.jpg" alt="img"
													...
													<li class="dropdown-item">
														<div class="d-flex align-items-start cart-dropdown-item">
															<img src="build/assets/images/products/2.jpg" alt="img"
																class="avatar avatar-md br-5 me-3">
															<div class="flex-grow-1">
																<div
																	class="d-flex align-items-start justify-content-between mb-0">
													...
													<li class="dropdown-item">
														<div class="d-flex align-items-start cart-dropdown-item">
															<img src="build/assets/images/products/1.jpg" alt="img"
																class="avatar avatar-md br-5 me-3">
															<div class="flex-grow-1">
																<div
																	class="d-flex align-items-start justify-content-between mb-0">
													...
													<li class="dropdown-item">
														<div class="d-flex align-items-start cart-dropdown-item">
															<img src="build/assets/images/products/3.jpg" alt="img"
																class="avatar avatar-md br-5 me-3">
															<div class="flex-grow-1">
																<div
																	class="d-flex align-items-start justify-content-between mb-0">
													...
													<li class="dropdown-item">
														<div class="d-flex align-items-start cart-dropdown-item">
															<img src="build/assets/images/products/5.jpg" alt="img"
																class="avatar avatar-md br-5 me-3">
															<div class="flex-grow-1">
																<div
																	class="d-flex align-items-start justify-content-between mb-0">
																	...
																	<div>
																		...
																		<a href="profile.html"
																			...
																			<span class="avatar avatar-sm brround">
																				<img src="build/assets/images/users/1.jpg"
        ...
        <link rel="modulepreload" href="build/assets/profile-5453c487.js" /><script type="module" src="build/assets/profile-5453c487.js"></script>
        
        <!-- Sticky JS -->
        <script src="build/assets/sticky.js"></script>

        <!-- APP JS-->
		<link rel="modulepreload" href="build/assets/app-6df099bd.js" /><link rel="modulepreload" href="build/assets/defaultmenu-7feba3a7.js" /><script type="module" src="build/assets/app-6df099bd.js"></script>       
        <!-- END SCRIPTS -->
